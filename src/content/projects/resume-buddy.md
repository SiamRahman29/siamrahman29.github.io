...
It isn't a blank LaTeX editor. The plugin bakes in resume principles distilled from the **Dartmouth College CPD Resume Guide** and techniques from career coach [@jerryjhlee](https://www.instagram.com/jerryjhlee), so the AI isn't just formatting text — it's nudging toward resumes that actually read well to recruiters.
